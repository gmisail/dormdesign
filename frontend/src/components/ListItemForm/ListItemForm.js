        ...
        return (
            <Form noValidate validated={this.state.validated} onSubmit={this.onFormSubmit}>
                ...
                <Form.Group controlId="formItemQuantity" controlId="validationCustomQty">
                    ...
                    <Form.Control name="qtyInputValue" type="number" value={this.state.qtyInputValue} placeholder="How many of this item" onChange={this.handleInputChange} onKeyDown={ (evt) => ((evt.key === 'e' || evt.key === '.' || evt.key === '-') && evt.preventDefault()) } required />
                    <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="formItemQuantity" controlId="validationCustomQty">
                    ...
                    <Form.Row>
                        <Col>
                            <Form.Control name="widthInputValue" type="number" value={this.state.widthInputValue} placeholder="Width" onChange={this.handleInputChange} onKeyDown={ evt => ((evt.key === 'e' || evt.key === '-') && evt.preventDefault()) } />
                        </Col>
                        <Col>
                            <Form.Control name="lengthInputValue" type="number" value={this.state.lengthInputValue} placeholder="Length" onChange={this.handleInputChange} onKeyDown={ evt => ((evt.key === 'e' || evt.key === '-') && evt.preventDefault()) } />
                        </Col>
                    </Form.Row>
                </Form.Group>
