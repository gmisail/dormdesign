...
//         loading: true,
//       };
//     case actions.RECEIVED_RESPONSE:
//       return {
//         ...state,
//       };
//     case actions.ERROR:
...
// const useFetch = (url) => {
//   const [state, dispatch] = useReducer(fetchReducer, initalDataState);
//   const { id } = useParams();
...
//           `${response.status} Error fetching list: ${data.message}`
//         );
